...
<div class="page-header">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Service Pending List</li>
  ...
  <div class="row">
    <div class="col-lg-12 stretch-card">
        <div class="card">
          <div class="card-body">
            <h4 class="card-title text-center">Service Pending List</h4>
                  ...
                  @foreach ($services as $service)
                    <tr class="table-info">
                      ...
                      <td> 
                        {{$service->name}}
                        <div class="mt-2">
                          <a class="text-primary text-decoration-none h4" href="">
                            <i class="mdi mdi-eye"></i>
                          </a>
                          <a class="text-secondary text-decoration-none h4" href="">
